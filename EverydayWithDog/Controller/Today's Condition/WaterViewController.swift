...
class WaterViewController: UIViewController {
    ...
    func textFieldSetup(){
        drinkTimeTextView.layer.cornerRadius = 6
        drinkTimeTextView.layer.borderWidth = 0.8
        
        drinkPlaceView.layer.cornerRadius = 6
        drinkPlaceView.layer.borderWidth = 0.8
        
        drinkQuantityView.layer.cornerRadius = 6
        drinkQuantityView.layer.borderWidth = 0.8
